...
st.markdown("Vehiclecollision between %i:00 and %i:00" % (hour, (hour + 1) %24))
...
st.subheader("Breakdownby MInute between an %i:00 and %i:00" %(hour,(hour + 1) %24))
filtered = data[
...
select = st.selectbox('Affected Type Of People', ['Pedestrian','Cyclist','Motorists'])
